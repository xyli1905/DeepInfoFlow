...
class BaseOption:
    ...
    def initialize(self):
        ...
        self._parser.add_argument('--lr', type=float, default=0.002, help='learning rate')
        self._parser.add_argument('--momentum', type=float, default=0.9, help='SGD momentum')
        self._parser.add_argument('--max_epoch', type=int, default=2000, help='number of epochs')

...
class BaseOption:
    ...
    def initialize(self):
        ...
        self._parser.add_argument('--experiment_name', type=str, default='sigmoid_ADAM', help='a unique name for experiment')
        ...
        self._parser.add_argument('--max_epoch', type=int, default=10000, help='number of epochs')
        ...
        self._parser.add_argument('--activation', type=str, default='sigmoid', help='activation method')
